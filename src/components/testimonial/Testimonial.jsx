  ...
  const testimonials = [
    {
      ...
      role: "Client",
      img: Test1,
      text: "I have a lovely experience with Digital Top Guns as far as my social media marketing and website maintenance is concerned. Satisfied with the services and quick response!"
    },
    {
      name: "Mansie Dewan",
      role: "Client",
