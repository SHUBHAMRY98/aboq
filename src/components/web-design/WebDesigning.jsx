...
<source media="(max-width: 768px)" srcSet={MobileBanner} />
    ...
    <img src={DesktopBanner} alt="Banner" className="responsive-banner" />
      ...
      <div className="ws-container">
        ...
        <div className="ws-header">
            ...
            <h2 class="title-text">What Includes in Our Web Designing</h2>
        ...
        <section className="service-section">
         <div className="service-container">
          ...
          <motion.div
            ...
            >
            <h2 className="title-text">Best website designing company, Delhi-NCR</h2>
  ...
  <p>
    ...
    credibility and create meaningful digital experiences. We cater to businesses
    across a wide range of industries.
  </p>

  <p>
    If you are searching for a <strong>“website designer near me”</strong>,
    ABOQ India is the right choice for your business.
    We focus on every design detail—from layout and usability to responsiveness
    and branding—to create websites that engage users and drive results.
  </p>
</div>
